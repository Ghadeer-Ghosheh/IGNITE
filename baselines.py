...
saits.fit(X_training)  # train the model. Here I use the whole dataset as the training set, because ground truth is not visible to the model.
imputation = saits.impute(X_test)  # impute the originally-missing values and artificially-missing values
print(imputation.shape)
